...
/**
* @fn void acThreadConditionVariableWait(pthread_cond_t* pConditionVariable, pthread_mutex_t* pMutex);
*
* @param pConditionVariable
*  - Type: pthread_cond_t*
*  - [In] parameter
...
*/
void acThreadConditionVariableWait(pthread_cond_t* pConditionVariable, pthread_mutex_t* pMutex);
